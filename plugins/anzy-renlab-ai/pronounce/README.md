...
<p align="center"><strong>Stop saying "kub-cuttle". One Bash command pronounces 1,848+ developer jargon names — most with a cited source.</strong></p>
...
<a href="https://pronounce.renlab.ai/browse"><img src="https://img.shields.io/badge/dictionary-1848%20entries-8fd694" alt="Entries"></a>
...
Every cell has IPA, audio, and the source. **[Hear all 1,848 →](https://pronounce.renlab.ai/browse)**
...
- ✅ **1,229** of 1,848 entries carry a citable source — the rest are confidence-tagged, no fabricated citations.
