...
```bash
pipx install --force "plugin-scanner==2.0.911"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `a50f09ffbe69840b8362d7b410324f2e91556a4db541e23b162bc9d81677eeab`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==2.0.911"
