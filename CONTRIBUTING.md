...
```bash
pipx install --force "plugin-scanner==2.0.868"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `fd984c456acb64568e25179ddf4ad164e7af350f49650d636011d839905b7634`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==2.0.868"
