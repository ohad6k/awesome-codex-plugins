...
```bash
pipx install --force "plugin-scanner==2.0.892"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `926cfcdb23bd69f4d7027508cbd663d54082ddb5c27b4e26bb0b82b4b70df5af`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==2.0.892"
