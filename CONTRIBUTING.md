...
```bash
pipx install --force "plugin-scanner==2.0.877"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `b0bff867175813aac93598bb76bbf4c2f1a70d3f9e0089a58e6c45b27d059e9c`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==2.0.877"
