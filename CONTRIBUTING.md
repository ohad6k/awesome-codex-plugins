...
```bash
pipx install --force "plugin-scanner==2.0.903"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `0a225fef02329b38fecaaf14cd5ca307ca0a6afae80beddf640b28b0c148e329`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==2.0.903"
