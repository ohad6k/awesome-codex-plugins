...
```bash
pipx install --force "plugin-scanner==2.0.876"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `b75e2ce01bcccfd314a0953b0241dc75a95d325704946e3817c986463d42f4dd`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==2.0.876"
