...
```bash
pipx install --force "plugin-scanner==2.0.887"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `e1fd253bc199c07c4a7e022928e162ea95cee1cfd5b9f77f8d22e1cb2ea9f6d6`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==2.0.887"
